...
public class SportbookPage extends BasePage {
  ...
  WebElement tabMulti;
  // @FindBy (xpath = "//div[@class='MuiInputBase-root jss142 jss373
  // MuiInputBase-fullWidth MuiInputBase-adornedEnd jss149']")
  ...
  public void getMessageAccountLevel(String stake) throws InterruptedException {
    ...
    click(tabMulti);
    Thread.sleep(500);
    WebElement stakeValue = driver
        .findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[4]/div[1]/input[1]"));
