...
public class SettingPage extends BasePage {
  ...
  public void setSelftExclude() throws InterruptedException {
    ...
    String timeSelfExclude = driver
        .findElement(By.xpath("//p[contains(text(),'not be able to make any bets until')]")).getText();
  ...
  public void setSpendingLimit(String money) throws InterruptedException {
    ...
    settingButton.click();
    driver.findElement(
        By.xpath("//body/div[@id='root']/main[1]/div[2]/div[2]/div[1]/div[3]/div[1]/div[1]/div[2]/a[1]"))
        .click();
    Thread.sleep(300);
  ...
  public void updateAccountLevel1(String firstName, String lastName, String date, String address, String city,
      String state, String cName) throws InterruptedException {
    Thread.sleep(1000);
    menu.click();
    Thread.sleep(300);
    settingButton.click();
    ...
    String notiSuccess = driver
        .findElement(By.xpath("//div[contains(text(),'Account verification level 1 completed.')]")).getText();
